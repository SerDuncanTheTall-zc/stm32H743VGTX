...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13|OV5640_RESET_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PC13 Trig_Pin OV5640_RESET_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_13|Trig_Pin|OV5640_RESET_Pin;
